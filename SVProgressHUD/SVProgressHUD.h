...
@property (strong, nonatomic, nonnull) UIColor *fontColor UI_APPEARANCE_SELECTOR;                 // default is [UIColor blackColor]
...
+ (void)setFontColor:(nonnull UIColor*)color;                              // default is [UIColor blackColor]
